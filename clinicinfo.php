    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">Hospital Detail</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="">Home</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Hospital Detail</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5 py-10">
                ...
                <div class="d-flex justify-content-start">
                    ...
                    <a class="btn btn-outline-danger btn-square mr-2" href="https://www.instagram.com/localtradestreets/"><i class="fab fa-instagram"></i></a>
                </div>
            </div>
